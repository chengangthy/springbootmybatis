...
<div class="wrap">
  ...
  <div class="sale">
    ...
    <div class="logout right"><a href="#" title="注销">注销</a></div>
  		...
  		<form action="${pageContext.request.contextPath}/insert.action" method="post" enctype="multipart/form-data" onsubmit="return test()">
      <div class="login logns produce">
        <h1 class="blues">拍卖品信息</h1>
          <dl>
            <dd >
              <label>名称：</label>
              <input type="text" class="inputh lf" name="auction_name"  id="in1" onblur="test1()"/>
              <div class="lf red laba" id="div1"></div>
            </dd>
            <dd>
              <label>起拍价：</label>
              <input type="text" class="inputh lf" name="auction_start_price" id="in2" onblur="test2()"/>
              <div class="lf red laba" id="div2"></div>
            </dd>
            <dd>
              <label>底价：</label>
              <input type="text" class="inputh lf" name="auction_upset" id="in3" onblur="test3()"/>
              <div class="lf red laba" id="div3"></div>
            </dd>
            <dd>
              <label>开始时间：</label>
              <input type="text" class="inputh lf" name="auction_start_time" id="in4" onblur="test4()"/>
              <div class="lf red laba" id="div4"></div>
            </dd>
            <dd>
              <label>结束时间：</label>
              <input type="text" class="inputh lf" name="auction_end_time" id="in5" onblur="test5()"/>
              <div class="lf red laba" id="div5"></div>
            </dd>
            <dd class="dds">
              <label>描述：</label>
            ...
            <dd>
              ...
              <div class="lf salebd"><a href="#"><img src="images/ad20.jpg" width="100" height="100" /></a></div>
               <input name="pic" type="file" class="marg10"  value="sasas"/>
            </dd>
            <dd class="hegas">
